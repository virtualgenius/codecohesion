...
exports.createRepoNotFoundError = createRepoNotFoundError;
 ...
 */
function createNotFoundError(message, suggestions, helpActions) {
    const error = {
        error: 'Not found',
        code: 'NOT_FOUND',
        message
...
function createRepoNotFoundError(requestedId, allRepos) {
...
function createInvalidParameterError(paramName, value, constraint, example) {
    return {
...
function createMissingParameterError(paramName, paramType, paramFormat, example) {
    return {
 ...
 */
function findSimilarRepos(requested, allRepos) {
